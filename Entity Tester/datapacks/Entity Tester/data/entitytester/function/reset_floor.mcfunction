...
execute if score global entitytester_mode matches 2 run execute if score global entitytester_variants matches 1 run place template entitytester:floor_blocks -4 -60 -56
