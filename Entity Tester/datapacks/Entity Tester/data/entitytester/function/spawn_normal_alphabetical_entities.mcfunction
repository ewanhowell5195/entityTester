...
setblock 13 -60 -29 barrier
setblock -13 319 -22 tinted_glass
setblock -5 -60 -22 piglin_head[rotation=8]
setblock -1 -60 -22 player_head[rotation=8]
setblock -9 -60 -16 shulker_box
setblock -5 -60 -16 oak_sign
