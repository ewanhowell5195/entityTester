...
execute if score global entitytester_mode matches 2 run execute if score global entitytester_variants matches 1 run function entitytester:create_structure_71x51
